...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe, gcaptcha_sitekey }){
  let div = dom('.splash',
    dom('<img src="https://fronteranews.com/wp-content/uploads/2016/05/FPRObold.jpg" width="300px">'),
    dom('br'),
    dom('p','We are an open community for emerging markets finance and investment'),
    dom('br'),
    !iframe && dom('.logos',
      logo && dom('.logo.org'),
      dom('.logo.slack')
